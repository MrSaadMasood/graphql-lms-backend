...
import { buyMoreTokensQuery, consumeTokensQuery } from "../../sqlQueries/reusedSQLQueries"
...
export async function ConsumeToken(
  ...
  const reduceTokens = await pgPool.query(consumeTokensQuery, ["hamza@gmail.com"])
...
export async function BuyMoreTokens() {
  const updateFreeTokens = await pgPool.query(
    buyMoreTokensQuery, ["hamza@gmail.com"])
