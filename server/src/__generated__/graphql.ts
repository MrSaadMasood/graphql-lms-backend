...
> = {
  GoogleLogin?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<MutationGoogleLoginArgs, 'code'>
  >;
  LoginUser?: Resolver<
    ResolversTypes['Tokens'],
    ParentType,
  ...
  >;
  RefreshUser?: Resolver<
    ResolversTypes['AccessToken'],
    ParentType,
    ContextType,
    RequireFields<MutationRefreshUserArgs, 'input'>
  >;
  SignUpUser?: Resolver<
...
> = {
  dummy?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<QueryDummyArgs, 'id'>
  >;
};
...
export type SuccessResolvers<
  ContextType = any,
  ParentType extends
    ResolversParentTypes['Success'] = ResolversParentTypes['Success'],
> = {
